...
const Services = () => {
  ...
  const services: ServiceCategory[] = [
    ...
    },
    {
      ...
      details: [
        "Vikariat (max 4 veckor)",
        "Åtgärder för resurskrävande ärenden",
        "Stöd vid kluriga situationer",
        "Exempel: Klasser med utåtagerande elever, gängproblematik, NPF"
      ]
    },
    {
      id: "dokumentation",
                    ...
                    <div className="mt-4 pt-4 border-t border-border animate-in slide-in-from-top-2">
                      <ul className="space-y-2">
                        {service.details.map((detail, index) => (
                          <li 
                            key={index} 
                            className="text-foreground/80 text-sm pl-4 border-l-2 border-primary/30"
                          >
                            {detail}
                          </li>
                        ))}
